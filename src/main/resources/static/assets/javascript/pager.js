function Page(_ref) { 
    ...
    init: function init()
        ...
        var li = document.createElement('li'); 
            ...
            li.onclick = function () { 
                that.curPage = parseInt(this.innerHTML);
                 that.init(); that.getPage(that.curPage); 
                };
             }
            li.innerHTML = item; 
            that.ul.appendChild(li);
        }); 
        that.nextPage(); that.finalPage();
     ...
     firstPage: function firstPage() {
          ...
          var li = document.createElement('li');
           ...
           li.onclick = function () {
                var val = parseInt(1); 
                that.curPage = val; that.getPage(that.curPage); 
                that.init(); 
            };
         },
    lastPage: function lastPage() {
     ...
     getPages: function getPages() {
        ...
        var that = this; var li = document.createElement('li'); 
        li.innerHTML = '>';
        ...
        var that = this;
         var li = document.createElement('li');
           ...
           var span1 = document.createElement('span');
            ...
            var input = document.createElement('input'); input.setAttribute("type", "number"); 
    ...
    showPageTotal: function showPageTotal() {
         var that = this;
          var li = document.createElement('li'); 
          li.innerHTML = '共' + that.pageTotal + '&nbsp页';
           li.className = 'totalPage'; 
           this.ul.appendChild(li);
            var li2 = document.createElement('li');
            li2.innerHTML = '每页' + that.pageAmount + '条';
            li2.className = 'pageAmount';
            this.ul.appendChild(li2); var li3 = document.createElement('li'); 
            li3.innerHTML = '合计' + that.dataTotal + '条数据'; 
            li3.className = 'pageAmount'; 
